                                ...
                                <div class="p-4">
                                    <div class="h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
                                        ...
                                        <div className='flex justify-center absolute bottom-10 left-0 w-full py-4'>
                                            <button onClick={() => Vote(Number(e.uniqueid.toString()))} class="flex mx-auto mt-10 text-white bg-blue-400 border-0 py-2 px-8 focus:outline-none hover:bg-yellow-600 rounded">Vote</button>
                                            <button onClick={() => Donate(Number(e.uniqueid.toString()))} class="flex mx-auto mt-10 text-white bg-green-400 border-0 py-2 px-8 focus:outline-none hover:bg-yellow-600 rounded">Donate</button>
                                        </div>
                                    </div>
                                </div>
                            )
